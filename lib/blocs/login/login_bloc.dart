...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  Future<void> _checkUserInformation(
    ...
    var professionalInfo = await FirebaseFirestore.instance
        .collection('users')
        .doc(user.uid)
        .collection('professional_info')
        .get();
    if (professionalInfo.docs.isEmpty) {
      emit(ProfessionalInfoMissing(
          user: user)); //Estado para infomação profissional faltante
      return;
    }
  }
}
